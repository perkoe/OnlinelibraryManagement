<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinvetory.aspx.cs" Inherits="WebApplication1.adminbookinvetory" %>
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Text='<%# Eval("language") %>'></asp:Label> </span>
